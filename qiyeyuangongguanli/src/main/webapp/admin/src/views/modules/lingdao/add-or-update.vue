               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="领导姓名" prop="lingdaoName">
                       <el-input v-model="ruleForm.lingdaoName"
                                 placeholder="领导姓名" clearable  :readonly="ro.lingdaoName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="领导手机号" prop="lingdaoPhone">
                       <el-input v-model="ruleForm.lingdaoPhone"
                                 placeholder="领导手机号" clearable  :readonly="ro.lingdaoPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="lingdaoEmail">
                       <el-input v-model="ruleForm.lingdaoEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.lingdaoEmail"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   lingdaoPhoto: [
                              { required: true, message: '领导头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`lingdao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
