    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="考勤扣减" prop="kaoqinkoujianJine">
                       <el-input v-model="ruleForm.kaoqinkoujianJine"
                                 placeholder="考勤扣减" clearable  :readonly="ro.kaoqinkoujianJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="考勤扣减" prop="kaoqinkoujianJine">
                           <el-input v-model="ruleForm.kaoqinkoujianJine"
                                     placeholder="考勤扣减" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <!--<el-col :span="12">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   yuangongId: [
                              { required: true, message: '普通员工不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   kaoqinkoujianJine: [
                              { required: true, message: '考勤扣减不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
