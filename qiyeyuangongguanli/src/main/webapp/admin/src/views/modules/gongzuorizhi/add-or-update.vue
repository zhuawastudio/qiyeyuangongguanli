    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="日志标题" prop="gongzuorizhiName">
                       <el-input v-model="ruleForm.gongzuorizhiName"
                                 placeholder="日志标题" clearable  :readonly="ro.gongzuorizhiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="日志标题" prop="gongzuorizhiName">
                           <el-input v-model="ruleForm.gongzuorizhiName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="日志类型" prop="gongzuorizhiTypes">
                        <el-select v-model="ruleForm.gongzuorizhiTypes" :disabled="ro.gongzuorizhiTypes" placeholder="请选择日志类型">
                            <el-option
                                v-for="(item,index) in gongzuorizhiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="日志类型" prop="gongzuorizhiValue">
                        <el-input v-model="ruleForm.gongzuorizhiValue"
                            placeholder="日志类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="日志详情" prop="gongzuorizhiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.gongzuorizhiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gongzuorizhiContent" label="日志详情" prop="gongzuorizhiContent">
                            <span v-html="ruleForm.gongzuorizhiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yuangongId: false,
                    gongzuorizhiName: false,
                    gongzuorizhiTypes: false,
                    gongzuorizhiContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yuangongId: '',
                ...
                rules: {
                   ...
                   gongzuorizhiContent: [
                              { required: true, message: '日志详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=gongzuorizhi_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.gongzuorizhiTypesOptions = data.data.list;
                    }
                });
